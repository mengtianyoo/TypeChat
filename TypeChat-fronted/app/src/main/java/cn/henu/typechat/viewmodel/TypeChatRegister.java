...
public class TypeChatRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerbuttton.setOnClickListener(v -> {
            ...
            call.enqueue(new Callback<DataModel2>() {
                @Override
                public void onResponse(@NonNull Call<DataModel2> call, @NonNull Response<DataModel2> response) {
                ...
                @Override
                public void onFailure(@NonNull Call<DataModel2> call, @NonNull Throwable t) {
                    // 处理网络请求失败的情况
